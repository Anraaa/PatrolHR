...
<?php $component->withAttributes(['livewire' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($livewire)]); ?>
    ...
    >
        ...
        >
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($emptyPanelView): ?>
                <?php echo $__env->make($emptyPanelView, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php else: ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($emptyPanelBackgroundImageUrl): ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/vendor/diogogpinto/filament-auth-ui-enhancer/resources/views/custom-auth-layout.blade.php ENDPATH**/ ?>