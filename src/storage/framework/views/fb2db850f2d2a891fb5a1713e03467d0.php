...
<?php $component->withAttributes(['@refresh-component' => '$refresh']); ?>
    ...
    <div class="space-y-6 custom-scroll">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex flex-wrap gap-2 mt-1">
                        <span class="inline-flex items-center gap-1.5 bg-white/20 backdrop-blur-sm border border-white/30 text-white text-xs font-bold px-3 py-1.5 rounded-full">
                            <span class="h-2 w-2 rounded-full bg-emerald-300 animate-pulse"></span><?php echo e($totalPatrolMonth); ?> Patrol Selesai
                        </span>
                        <span class="inline-flex items-center gap-1.5 bg-white/20 backdrop-blur-sm border border-white/30 text-white text-xs font-bold px-3 py-1.5 rounded-full">
                            <span class="h-2 w-2 rounded-full bg-rose-300"></span><?php echo e($totalMissedMonth); ?> Missed
                        </span>
                        <span class="inline-flex items-center gap-1.5 bg-white/20 backdrop-blur-sm border border-white/30 text-white text-xs font-bold px-3 py-1.5 rounded-full">
                            <span class="h-2 w-2 rounded-full bg-amber-300"></span><?php echo e($ratePercent); ?>% Rate
                        </span>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="stat-card rounded-2xl p-5 shadow-xl" style="background:linear-gradient(135deg,#3b82f6,#06b6d4)">
                ...
                <div class="flex items-start justify-between mb-3">
                    <div>
                        ...
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-white"><?php echo e($activeUsers); ?></span>
                            <span class="text-xs font-semibold text-blue-200">dari <?php echo e($totalUsers); ?></span>
                        </div>
                    </div>
                ...
                <div class="h-1.5 w-full rounded-full bg-white/20 overflow-hidden">
                    <div class="h-full bg-white/60 rounded-full progress-bar" style="width:<?php echo e($activeRate); ?>%"></div>
                </div>
            </div>
            ...
            <div class="overflow-x-auto summary-surface">
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-indigo-50 dark:divide-gray-700/60 bg-white dark:bg-gray-800">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $picSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userId => $pic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr class="transition-colors duration-150 hover:bg-indigo-50/50 dark:hover:bg-indigo-900/10">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="flex h-11 w-11 items-center justify-center rounded-xl <?php echo e($avatarSolid[$ck]); ?> text-white text-sm font-black shadow-lg"><?php echo e($ini); ?></div>
                                        <div>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    ...
                                    <div class="text-xs text-gray-400 dark:text-gray-500">dari <?php echo e($pic['total_locations']); ?></div>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="text-xl font-black text-emerald-600 dark:text-emerald-400"><?php echo e($pic['patrols_completed']); ?></div>
                                    <div class="text-xs text-gray-400 dark:text-gray-500">dari <?php echo e($pic['patrols_total']); ?></div>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="w-32">
                                        <div class="flex justify-between mb-1">
                                            <span class="text-xs font-bold <?php echo e($cs['text']); ?>"><?php echo e($prg); ?>%</span>
                                        </div>
                                        <div class="h-2.5 w-full rounded-full bg-gray-100 dark:bg-gray-700 overflow-hidden shadow-inner">
                                            <div class="h-full rounded-full bg-gradient-to-r <?php echo e($cs['gradient']); ?> progress-bar" style="width:<?php echo e($prg); ?>%"></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-black text-white shadow-md bg-gradient-to-r <?php echo e($sg); ?>">
                                        <?php echo e($si); ?> <?php echo e($ov); ?>%
                                    </span>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <tr class="tbl-head-row">
                            <td colspan="6" class="px-6 py-3">
                                <div class="flex items-center justify-between text-xs">
                                    ...
                                    <span class="font-bold text-indigo-600 dark:text-indigo-400"><?php echo e(count($picSummary)); ?> Petugas</span>
                                </div>
                            </td>
                        </tr>
                    </tfoot>
        ...
        <div class="overflow-hidden rounded-2xl shadow-xl border border-indigo-100 dark:border-indigo-900/40">
            ...
            <div class="p-5 page-surface">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $locationPerformance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $li => $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <div class="loc-card group relative flex flex-col rounded-xl border <?php echo e($lbdl); ?> <?php echo e($lbdd); ?> <?php echo e($lbgl); ?> dark:bg-gray-800/70 p-4 shadow-md loc-card-surface">
                            <div class="absolute top-3 right-3">
                                <span class="inline-flex h-7 w-7 items-center justify-center rounded-full text-xs font-black text-white shadow-md bg-gradient-to-br <?php echo e($lg); ?>"><?php echo e($li+1); ?></span>
                            </div>
                            <div class="mb-3 pr-8">
                                <h4 class="font-black text-gray-900 dark:text-white text-sm"><?php echo e($loc['name']); ?></h4>
                                <p class="text-[10px] font-bold <?php echo e($ltl); ?> <?php echo e($ltd); ?> uppercase tracking-wider mt-0.5"><?php echo e($loc['users_patrolled']); ?>/<?php echo e($loc['total_users']); ?> PIC</p>
                            </div>
                            <div class="mb-2">
                                <span class="text-2xl font-black bg-gradient-to-r <?php echo e($lg); ?> bg-clip-text text-transparent"><?php echo e($loc['performance_percent']); ?>%</span>
                            </div>
                            <div class="w-full h-3 rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden mb-4 shadow-inner">
                                <div class="h-full rounded-full bg-gradient-to-r <?php echo e($lg); ?> shadow progress-bar" style="width:<?php echo e($loc['performance_percent']); ?>%"></div>
                            </div>
                            <div class="grid grid-cols-3 gap-2">
                                <div class="rounded-lg bg-white/80 dark:bg-gray-900/60 p-2 shadow-sm border border-white/60 dark:border-gray-700/60 text-center">
                                    <p class="text-sm font-black <?php echo e($ltl); ?> <?php echo e($ltd); ?>"><?php echo e($loc['users_patrolled']); ?></p>
                                    <p class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase mt-0.5">Aktif</p>
                                </div>
                                <div class="rounded-lg bg-white/80 dark:bg-gray-900/60 p-2 shadow-sm border border-white/60 dark:border-gray-700/60 text-center">
                                    <p class="text-sm font-black <?php echo e($ltl); ?> <?php echo e($ltd); ?>"><?php echo e($loc['total_patrols']); ?></p>
                                    <p class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase mt-0.5">Patrol</p>
                                </div>
                                <div class="rounded-lg bg-white/80 dark:bg-gray-900/60 p-2 shadow-sm border border-white/60 dark:border-gray-700/60 text-center">
                                    <p class="text-sm font-black <?php echo e($rem > 0 ? 'text-rose-600 dark:text-rose-400' : 'text-emerald-600 dark:text-emerald-400'); ?>"><?php echo e($rem); ?></p>
        ...
        <!--[if BLOCK]><![endif]--><?php if(count($picColors) > 0): ?>
        <div class="overflow-hidden rounded-2xl border border-indigo-100 dark:border-indigo-900/40 shadow-xl">
            ...
            <div class="flex flex-wrap gap-2.5 p-4 page-surface">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $picColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $picName => $colorIdx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="pic-badge flex items-center gap-2.5 rounded-xl border <?php echo e($cs['border']); ?> <?php echo e($cs['bg']); ?> pl-2 pr-4 py-1.5 shadow-md">
                        <span class="inline-flex h-8 w-8 items-center justify-center rounded-lg <?php echo e($avatarSolid[$ck]); ?> text-white text-[11px] font-black shadow-md"><?php echo e($ini); ?></span>
        ...
        <div class="overflow-hidden rounded-2xl shadow-xl border border-indigo-100 dark:border-indigo-800/40">
            ...
            <div class="cal-header-bg flex flex-col gap-3 border-b border-indigo-100 dark:border-indigo-900/40 px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-black text-gray-900 dark:text-white tracking-tight"><?php echo e($monthNameId[$data['month']]); ?> <?php echo e($data['year']); ?></h3>
                        <p class="text-xs font-semibold text-gray-500 dark:text-gray-400"><?php echo e($data['days_in_month']); ?> hari · <?php echo e(count($calendarData)); ?> hari aktif</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-7 border-b border-indigo-100 dark:border-gray-700">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $dayNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $dn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="py-3 text-center <?php echo e($dayColors[$i]); ?>">
            ...
            <div class="grid grid-cols-7 bg-white dark:bg-gray-800">
                <!--[if BLOCK]><![endif]--><?php for($b = 0; $b < $startBlank; $b++): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php for($day = 1; $day <= $data['days_in_month']; $day++): ?>
                    ...
                    <div
                        ...
                        tabindex="0"
                        role="button"
                        aria-label="Tanggal <?php echo e($day); ?>, <?php echo e($dayPatrol); ?> patrol"
                        class="cal-cell group min-h-[110px] border-b border-r border-indigo-50 dark:border-gray-700/40 p-3 cursor-pointer select-none focus:outline-none
                            <?php echo e($isWeekend ? 'cal-cell-weekend' : 'cal-cell-normal'); ?>">
                        ...
                        <div class="mb-2 flex items-center justify-between">
                            <span class="inline-flex h-7 w-7 items-center justify-center rounded-lg text-xs font-black transition-all duration-200
                                <?php echo e($isToday ? 'today-num' : ($isWeekend ? 'text-rose-500 dark:text-rose-400 group-hover:bg-rose-50 dark:group-hover:bg-rose-900/25' : 'text-gray-700 dark:text-gray-300 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-900/25')); ?>">
                                <?php echo e($day); ?>

                            </span>
                            <!--[if BLOCK]><![endif]--><?php if($hasData): ?>
                                <div class="relative flex items-center">
                                    <span class="inline-flex h-2.5 w-2.5 rounded-full shadow-sm
                                        <?php echo e($health === 'ok' ? 'bg-emerald-500' : ($health === 'bad' ? 'bg-rose-500 animate-pulse' : 'bg-amber-400')); ?>">
                                    </span>
                                    <!--[if BLOCK]><![endif]--><?php if($health === 'bad'): ?>
                        ...
                        <div class="space-y-1.5">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $showPics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $picName => $picData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="flex items-center justify-between gap-1 rounded-lg border <?php echo e($cs['border']); ?> <?php echo e($cs['bg']); ?> px-2 py-1.5 transition-all duration-150 hover:shadow-sm hover:-translate-y-px">
                                    <div class="flex items-center gap-1.5 min-w-0">
                                        <span class="h-2 w-2 rounded-full flex-shrink-0 <?php echo e($cs['dot']); ?> <?php echo e($picData['missed_count'] > 0 ? 'ring-2 ring-rose-400/50' : ''); ?>"></span>
                                        <span class="text-[10px] font-bold truncate <?php echo e($cs['text']); ?>"><?php echo e($sn); ?></span>
                                    </div>
                                    <div class="flex items-center gap-1">
                                        <span class="text-[10px] font-black <?php echo e($cs['text']); ?> px-1 py-0.5 rounded bg-white/60 dark:bg-black/20"><?php echo e($picData['patrol_count']); ?></span>
                                        <!--[if BLOCK]><![endif]--><?php if($pct < 100): ?>
                                            <span class="text-[9px] text-gray-400 dark:text-gray-500"><?php echo e($pct); ?>%</span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                            <!--[if BLOCK]><![endif]--><?php if($extraCount > 0): ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(!$hasData && !$isWeekend): ?>
                ...
                <?php $trail = (7 - (($startBlank + $data['days_in_month']) % 7)) % 7; ?>
                <!--[if BLOCK]><![endif]--><?php for($t = 0; $t < $trail; $t++): ?>
                    <div class="min-h-[110px] border-b border-r border-indigo-50 dark:border-gray-700/40 cal-cell-blank"></div>
                <?php endfor; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('keydown', e => {
            ...
            if (selectedDay !== null && (e.key === 'ArrowLeft' || e.key === 'ArrowRight')) {
                ...
                if (n >= 1 && n <= <?php echo e($data['days_in_month']); ?>) selectDay(n);
            }
        });
